...
class ScrumSprint(models.Model):
    ...
    def _get_current_id(self):
        ...
        if meeting_type == "planning":  # Sprint Planning Items
            print "id from sprint", meeting_type, meeting_id
        ...
        print "id records: ", meeting_type, meeting_id
    ...
    def _compute_def_scrum_master(self):
        scrum_master = self.project_id.scrum_master_id
        self.scrum_master_id = scrum_master
        ...
        for record in self:
            if record.date_stop and record.date_start and record.state != "cancel":
                if fields.Date.from_string(record.date_start) >= date.today():
                    ...
                    record.state = "done"
            print "sprint _state", record.name, record.state
